...
            # SOLUCIÓN MAESTRA: Calculamos cuántas columnas extra tiene físicamente el archivo y creamos celdas vacías simétricas
            columnas_totales = len(df_global.columns)
            datos_nuevos = [ed_id, ed_nom, ed_cor, ed_cen, ed_pue, ed_seg, ed_gen, ed_dir, str(datos_actuales.iloc[8])]
            extras = [""] * (columnas_totales - len(datos_nuevos))
            
            df_global.iloc[indice_fila] = datos_nuevos + extras
